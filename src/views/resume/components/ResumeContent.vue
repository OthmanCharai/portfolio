...
import KnowlogeCard from "./KnowlogeCard.vue";
</script>
<template lang="">
        ...
        <div data-aos="fade" class="aos-init aos-animate">
            <div class="container sm:px-5 md:px-10 lg:px-20">
                <div class="py-12 px-4">
                    <h2
                        class="after-effect after:left-44 mb-[40px] mt-12 lg:mt-0"
                    >
                        Resume
                    </h2>
                    <div
                    ...
                    >
                        ...
                        <div>
                            <div class="flex items-center space-x-2 mb-4">
                                ...
                                ></i>
                                <h4
                                    class="text-5xl dark:text-white font-medium"
                                >
                                    Education
                                </h4>
                            </div>
                            ...
                            >
                                <span
                                    class="text-tiny text-gray-lite dark:text-[#b7b7b7]"
                                    >2021-2023</span
                                >
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-2 mb-4">
                                <i
                                    class="fa-solid fa-award text-6xl text-[#F95054]"
                                ></i>
                                <h4
                                    class="text-5xl dark:text-white font-medium"
                                >
